...
public class LayoutConstraints {
	 ...
	 * 
	 * @param gb
	 *            GridBagLayout que contêm o componente
	 * @param gridx
	 *            Coluna onde o componente será inserido
	 * @param gridy
	 *            Linha onde o componente será inserido
	 * @param gridwidth
	 *            Quantidade de colunas que o componente ocupará
	 * @param gridheight
	 *            Quantidade de linhas que o componente ocupará
	 * @param weightx
	 *            Proporção que as colunas ocupadas pelo componente terão
	 * @param weighty
