...
public class VagasOferecidasTableModel extends JPanel {
	...
	class MyTableModel extends AbstractTableModel {
		...
		private String[] columnNames = {"Codigo do Curso", "Nome do Curso", "Semestre", "Codigo da Disciplina", "Disciplina", "Turma", "Horário", "Turnos", "Total de Vagas",  "Vagas Periotizados: Oferecidas/Solicitadas", "Vagas Desperiotizados: Oferecidas/Solicitadas"};
