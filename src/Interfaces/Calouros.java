...
//                CalourosTableModel.MyTableModel model = (CalourosTableModel.MyTableModel) tabela.getTable().getModel();
//                
...
//                   timetablebd.Calouros calouros; //cria um novo curso
//                   //captura os dados inseridos na tabela e os insere no curso
//                   calouros = new timetablebd.Calouros(Integer.parseInt(tabela.getTable().getValueAt((model.getData().size()-1) - (i), 1).toString()),
//                                                 Integer.parseInt(tabela.getTable().getValueAt((model.getData().size()-1) - (i), 2).toString()));
//                   
//                    
//                   //insere este novo curso no banco de dados
//                   HibernateUtil.saveOrUpdate(calouros);
//                }
